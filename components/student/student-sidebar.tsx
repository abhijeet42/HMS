...
export default function StudentSidebar() {
  ...
  return (
    <>
      {/* Mobile Top Bar */}
      <div className="lg:hidden flex items-center justify-between bg-brand-navy p-4 text-white sticky top-0 z-40 shadow-sm">
        ...
        <button onClick={() => setIsOpen(!isOpen)} className="p-2 -mr-2 rounded-md hover:bg-white/10 transition-colors">
          {isOpen ? <X /> : <Menu />}
        </button>
      </div>
      ...
      <aside className={`
        ...
        w-64 bg-brand-navy text-white flex flex-col shadow-xl lg:shadow-none
      ...
      `}>
        ...
        <div className="px-6 pb-6">
          <div className="bg-white/10 rounded-lg px-3 py-2 flex items-center gap-2 text-sm text-brand-gold font-medium border border-white/5">
        ...
        <div className="p-4 border-t border-white/10">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-red-500/10 hover:text-red-400 transition-colors"
          >
